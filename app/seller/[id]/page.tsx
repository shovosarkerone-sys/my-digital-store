...
export default function SellerPublicProfile() {
  ...
  const level = BUYER_LEVELS[seller?.seller_level || 3] || BUYER_LEVELS[3];
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-white">Products by this Seller</h2>
              <p className="text-xs text-slate-400">
                Browse genuine digital licenses and codes offered by {seller?.shop_name}.
              </p>
            </div>
          ...
          {products.length === 0 ? (
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-12 text-center text-slate-500 text-xs">
              This merchant has not listed any active items yet.
            </div>
          ) : (
