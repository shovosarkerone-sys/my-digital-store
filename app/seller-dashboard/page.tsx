...
export default function SellerDashboard() {
  ...
  // 2-Step Product Creation States (Identical to Admin /4517)
  ...
  // স্বয়ংক্রিয় সেলার লেভেল ক্যালকুলেশন
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          ...
          <div className="flex items-center gap-2.5">
            <Link
              href={`/seller/${user.id}`}
              className="text-xs text-sky-400 hover:text-white bg-sky-500/10 border border-sky-500/20 px-3 py-1.5 rounded-xl transition font-bold"
            >
              🏪 View Public Shop
            </Link>
            <Link
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">
                ...
                <span className="text-sky-400 font-semibold">{myProducts.length}</span> | Completed Orders:{" "}
                <span className="text-emerald-400 font-semibold">{seller.total_sales || 0}</span>
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full sm:w-auto text-xs font-bold bg-sky-500 hover:bg-sky-600 text-white px-4 py-2.5 rounded-xl transition cursor-pointer shadow-lg shadow-sky-950"
          >
            + Create New Listing
          </button>
        </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <button
                          ...
                          className="text-xs text-sky-400 hover:text-sky-300 bg-sky-500/10 border border-sky-500/20 px-3 py-1.5 rounded-xl transition cursor-pointer font-semibold"
                        >
                          Edit / Stock
                        </button>
                        <button
                          onClick={() => handleDeleteProduct(p.id)}
                          className="text-xs text-rose-400 hover:text-rose-300 bg-rose-500/10 border border-rose-500/20 px-3 py-1.5 rounded-xl transition cursor-pointer font-semibold"
                        >
                          Delete
                        </button>
                      </div>
        ...
        {/* TAB 2: 2-STEP PRODUCT PUBLISHING (IDENTICAL TO ADMIN /4517) */}
        {activeTab === "add_product" && (
          <div className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6 max-w-2xl mx-auto shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div>
            ...
            {productStep === 1 && (
              <form onSubmit={handleProductStepOne} className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold text-slate-200 mb-1.5">Product Title</label>
                  <input
                    type="text"
                    required
                    value={title}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-slate-200 mb-1.5">Regular Price (USD $)</label>
                    <input
                      type="number"
                      step="0.01"
                      required
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-200 mb-1.5">Discount Price (Optional)</label>
                    <input
                      type="number"
                      step="0.01"
                      value={discountPrice}
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-200 mb-1.5">Product Description</label>
                  <textarea
                    rows={3}
                    required
                    value={description}
                ...
                <div className="flex justify-end pt-2">
                  <button
                    type="submit"
                    className="px-6 py-2.5 bg-sky-500 hover:bg-sky-600 text-white font-bold text-xs rounded-xl cursor-pointer transition shadow-lg shadow-sky-950 flex items-center gap-2"
                  >
        ...
        {activeTab === "finances" && (
          <div className="space-y-6">
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 text-xs text-slate-400 space-y-3 leading-relaxed">
              <h3 className="font-bold text-white text-sm">36-Hour Escrow Protection & Payout Policy</h3>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs rounded-xl shadow-lg transition cursor-pointer"
                >
